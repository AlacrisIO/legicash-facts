...
1a- Trent posts invalid state update. Someone proves it in court.
1b- Trent times out.
...
2a- If details invalid or incomplete,
  Trent contests and gets Bob thrown out "come back with your file in order"
2b- Trent goes missing or invalid. See Facilitator invalidation story, then go back to 2c.
2c- Trent has to post his side of the story, with a side-chain state update.
...
5a- If Tara cheated, she loses her license, and both Tara and Trent go back to the invalidation flow.
5b- Tara is right, and makes a consolidated claim, that Trent and/or Victors can check
