      ...
      raise
        (Internal_error
           (Printf.sprintf "Bad private key length %d for %s" len
              (unparse_hex private_key_string)))
  in
  let _ =
...
let%test "inverse_1" =
  let key = "d5:69:84:dc:08:3d:76:97:01:71:4e:eb:1d:4c:47:a4:54:25:5a:3b:bc:3e:9f:44:84:20:8c:52:bd:a3:b6:4e"
  in invert_hex key = key

let%test "inverse_2" =
  let key = "04:7d:52:54:04:9f:02:3e:e7:aa:ea:1e:fa:4f:17:ae:70:0f:af:67:23:24:02:5a:a9:b5:32:5a:92:1f:d0:f1:51:0e:68:31:f1:bf:90:b4:a1:df:e1:cd:49:e5:03:ec:7d:b5:9f:6e:78:73:d0:3a:3a:09:6c:46:5c:87:22:22:69"
  in invert_hex key = key
