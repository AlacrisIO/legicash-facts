(* some dummy Secp256k1 key pairs *)
...
(* N.B.: if the private key generated by scripts/secp256k1.sh begins with a null (00) byte and is of length 33, remove the null byte *)
