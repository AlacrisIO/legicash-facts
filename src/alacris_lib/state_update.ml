 ...
 *)
let push_state_digest_exn (digest : Digest.t) (operator_revision : Revision.t) (value : TokenAmount.t) : Digest.t Lwt_exn.t =
...
let emit_claim_withdrawal_operation (contract_address : Address.t) (operator : Address.t) (operator_revision : Revision.t) (value : TokenAmount.t) (bond : TokenAmount.t) (digest : Digest.t) : unit Lwt_exn.t =
  Logging.log "emit_claim_withdrawal_operation : beginning of operation";
  ...
  Ethereum_user.make_pre_transaction ~sender:operator operation ?gas_limit:gas_limit_val bond
  >>= fun x ->
