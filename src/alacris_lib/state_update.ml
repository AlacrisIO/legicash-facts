 ...
 *)
let push_state_digest_exn (digest : Digest.t) (ticket : Revision.t) (bond : TokenAmount.t) (value : TokenAmount.t) : Digest.t Lwt_exn.t =
  Logging.log "push_state_digest_exn : beginning of function";
  let (operation : Ethereum_chain.Operation.t) = make_state_update_call digest ticket bond in
