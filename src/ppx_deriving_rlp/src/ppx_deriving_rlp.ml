...
let case_else_data_type_mismatch s =
  Exp.case (pvar "v")
           (app (Exp.ident (lid "raise"))
                [Exp.construct (lid "Ppx_deriving_rlp_runtime.Rlp.Rlp_data_type_mismatch")
...
let supported_pervasives_types =
  ["unit"; "string"; "int"; "float"; "bool"; "list"; "option"]
...
let exp_rlp_item str_exp    = Exp.construct (lid "Ppx_deriving_rlp_runtime.Rlp.RlpItem") (Some str_exp)
let exp_rlp_items lst_exp   = Exp.construct (lid "Ppx_deriving_rlp_runtime.Rlp.RlpItems") (Some lst_exp)
let exp_rlp_items_list exps = exp_rlp_items (list exps)

let pat_rlp_item str_pat    = Pat.construct (lid "Ppx_deriving_rlp_runtime.Rlp.RlpItem") (Some str_pat)
let pat_rlp_items lst_pat   = Pat.construct (lid "Ppx_deriving_rlp_runtime.Rlp.RlpItems") (Some lst_pat)
...
let type_decl_variant_to_case i ({ pcd_name; pcd_args; pcd_res; pcd_loc; pcd_attributes }, tmp) =
  ...
  and name_tag = Ppx_deriving_rlp_runtime.Rlp_encode.encode_nat_as_string i
  ...
  let rlp_op_exps = {
    ...
    of_rlp_item_opt = (lam (pvar "x")
                        (Exp.try_
                          ...
                          [catching (lid "Ppx_deriving_rlp_runtime.Rlp.Rlp_data_type_mismatch")]));
    to_rlp = (lam (pvar "x")
               (app (Exp.ident (lid "Ppx_deriving_rlp_runtime.Rlp_encode.rlp_item_to_rlp"))
    ...
    of_rlp = (lam (pvar "x")
               (app (evar name.of_rlp_item)
                    (List.map evar param_of_rlp_names
                     @
                     [(app (Exp.ident (lid "Ppx_deriving_rlp_runtime.Rlp_decode.rlp_item_of_rlp")) [evar "x"])])));
    ...
    unmarshal_rlp = (lams (List.map pvar ["i"; "x"])
                      (app (Exp.ident (lid "Ppx_deriving_rlp_runtime.Private.unmarshal_of_of"))
                           [app (evar name.of_rlp_item)
                                (List.map evar param_of_rlp_names);
                            evar "i";
                            evar "x"]));
    unmarshal_rlp_opt = (lams (List.map pvar ["i"; "x"])
                          (Exp.try_
                            ...
                            (List.map catching [lid "Ppx_deriving_rlp_runtime.Rlp.Rlp_data_type_mismatch";
                                                lid "Ppx_deriving_rlp_runtime.Rlp.Rlp_unmarshaling_error"])));
    rlping = let rlping_to_rlp param = Exp.field (evar param) (lid "Ppx_deriving_rlp_runtime.Rlping.to_rlp_item")
             and rlping_of_rlp param = Exp.field (evar param) (lid "Ppx_deriving_rlp_runtime.Rlping.of_rlp_item") in
             (Exp.record
              [(lid "Ppx_deriving_rlp_runtime.Rlping.to_rlp_item", app (evar name.to_rlp_item) (List.map rlping_to_rlp param_rlping_names));
               (lid "Ppx_deriving_rlp_runtime.Rlping.of_rlp_item", app (evar name.of_rlp_item) (List.map rlping_of_rlp param_rlping_names));
               (lid "Ppx_deriving_rlp_runtime.Rlping.of_rlp_item_opt", app (evar name.of_rlp_item_opt) (List.map rlping_of_rlp param_rlping_names));
               (lid "Ppx_deriving_rlp_runtime.Rlping.to_rlp", app (evar name.to_rlp) (List.map rlping_to_rlp param_rlping_names));
               (lid "Ppx_deriving_rlp_runtime.Rlping.of_rlp", app (evar name.of_rlp) (List.map rlping_of_rlp param_rlping_names));
               (lid "Ppx_deriving_rlp_runtime.Rlping.of_rlp_opt", app (evar name.of_rlp_opt) (List.map rlping_of_rlp param_rlping_names));
               (lid "Ppx_deriving_rlp_runtime.Rlping.marshal_rlp", app (evar name.marshal_rlp) (List.map rlping_to_rlp param_rlping_names));
               (lid "Ppx_deriving_rlp_runtime.Rlping.unmarshal_rlp", app (evar name.unmarshal_rlp) (List.map rlping_of_rlp param_rlping_names));
               (lid "Ppx_deriving_rlp_runtime.Rlping.unmarshal_rlp_opt", app (evar name.unmarshal_rlp_opt) (List.map rlping_of_rlp param_rlping_names))]
              None)
  }
  in
...
let rlping_expr_of_typ typ =
  ...
  (app
    (Exp.ident (lid "Ppx_deriving_rlp_runtime.Private.rlping_of_to_and_of"))
    [to_exp; of_exp])
