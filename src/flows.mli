...
type facilitator_state = {
    ...
    current_change_number : revision_id;
    current_limit : token_amount; (* how much limit is unspent during this cycle *)
    per_account_limit : token_amount;
    chain_root : chain_state; (* when did we last update? *)
    last_posted_side_chain_root : side_chain_state; (* what did we last post? *)
    pending_transactions : certified_check_t signed list (* Q: indexed by expedited or not? *)
    (* pending lawsuits ? *)
  }
