...
type digest_t = Int256_t

type main_chain_height_t = Int32.t (* Number of consensus, if linear block-based. Timestamp if DAG-based? *)
type main_chain_header_t = digest_t (* Hash of the header for the height. *)
type duration_t = Int32.t (* difference for main_chain_height_t *)
 ...
 *)
type tx_header_t = {
    message_type : Int32.t; (* Type of the message *)
 ...
 *)
type rx_header_t = {
    root : main_chain_header_t;
    date : main_chain_height_t;
    timeout : duration_t;
  }
...
type account_status_confirmation_t = {
    tx_header : side_chain_tx_header_t;
    request: account_status_t signed;
  }
